                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        <motion.div
                            ...
                            className="bg-gradient-to-br from-[#059669] to-[#064e3b] rounded-[24px] sm:rounded-3xl p-5 sm:p-7 shadow-xl relative overflow-hidden text-white border border-white/10"
                        >
                            <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-10 -mt-10 blur-2xl"></div>
                            <div className="absolute bottom-0 left-0 w-24 h-24 bg-black/10 rounded-full -ml-8 -mb-8 blur-xl"></div>

                            <div className="relative z-10 text-center py-1 sm:py-2">
                                <p className="text-emerald-100 text-[11px] sm:text-sm font-medium mb-1 flex items-center justify-center gap-2">
